...
public class RandomSimulationPlayer implements Player
{
	...
	public RandomSimulationPlayer() {
		this(new int[] { 36, 20, 10, 1});
	}

	public RandomSimulationPlayer(int[] factors) {
		branchingFactors = factors;
	}
...
//		int branchCount = 1;
//		if (depth < branchingFactors.length)
//			branchCount = branchingFactors[depth - 1];
		int branchCount = (depth == 1 ? 36 : depth == 2 ? 20 : depth == 3 ? 10 : 1);
